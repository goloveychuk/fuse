...
/// Implementation of an overlayfs-like filesystem
...
extension OverlayVolume: FSVolume.PathConfOperations {
    var maximumLinkCount: Int {
        return 65000 // Typical limit for most filesystems
    }
    
    var maximumNameLength: Int {
        return 255 // Standard for many filesystems
    }
    ...
    var maximumXattrSize: Int {
        return 65536 // 64KB typical for extended attributes
    }
    
    var maximumFileSize: UInt64 {
        return UInt64.max // Maximum possible file size (8 EB)
    }
}
...
extension OverlayVolume: FSVolume.Operations {
    var supportedVolumeCapabilities: FSVolume.SupportedCapabilities {
        ...
        capabilities.supportsHardLinks = false // Not implementing hard links for simplicity
